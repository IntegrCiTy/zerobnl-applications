        ...
        if self.soo1 > 0.5 and self.soo2> 0.5:
           ...
           self.Tout = (self.Tin3*self.mdot3 + self.Tin4*self.mdot4)/ self.mdot	
            ...
            if self.soo1 > 0.5:
               ...
               self.mdot = max(1.,self.mdot1)
               self.Tout = self.Tin1
			  
            elif self.soo2> 0.5:

               self.mdot = max(1.,self.mdot2)
               self.Tout = self.Tin2	

            elif self.soo3> 0.5:

               self.mdot = max(1.,self.mdot3)
               self.Tout = self.Tin3
