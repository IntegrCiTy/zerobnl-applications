...
PC_Wset_plant                      = 30                                 # Installed power capacity              [MW]
PC_units_num                       = 1
...
PC_PinHPT                          = 125                                # Inlet pressure to HPT                 [bar]
PC_TinHPT                          = 535                                # HPT inlet temperature                 [°C]
##------------IPT exists only for Simple Rankine Cycle only--------------##

PC_PinIPT                          = 7                              # Inlet Pressure to IPT (which coincides with LPT in DC and Vattenfall cases)                [bar]
...
PC_HPT_pr                          = [125/100,100/7]                    # pressure ratios in turbine sections         [-]
PC_HPT_pr                          = np.array(PC_HPT_pr)
PC_IPT_PR                          = 0                                  # pressure ratios in turbine sections         [-] #only in simple Rankine case it has a value
PC_LPT_pr                          = [7/2.7,2.7/0.4]                            # pressure ratios in turbine sections         [-]
