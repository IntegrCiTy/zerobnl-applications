...
def errorW(FR):
    ...
    [PC_COND_Area, PC_COND2_Area, PC_COND1_Area,PC_W_HPT, PC_W_LPT,PC_Wparas, PC_W, APPROACH_COND1, PC_COND2_UA_DELTA, PC_COND_air_FR, PC_COND_fan_Power, PC_COND_Tcout, PC_COND_UA,PC_coldPH, PC_hotPH, PC_coldSC, PC_hotSC, PC_PUMP_W2, PC_PUMP_W_DeaLP, PC_PumpBefMix_Power, PC_ECO_Q, PC_EV_Q ,PC_SH_Q,PC_Wgross_el,PC_W_el, PC_CONDs_Q, PC_st,PC_keyst_DEAin_n_st, PC_keyst_PUMP2out_n_st, PC_keyst_HPTin_n_st, PC_keyst_IPTin_n_st, PC_keyst_LPTin_n_st, PC_keyst_LPTout_n_st, PC_LPT_ETA, PC_IPT_ETA, PC_HPT_ETA] = rankine_reheat.rankine_reheat(PC_mdot)
